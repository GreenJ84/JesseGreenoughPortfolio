  ...
  return (
    ...
    >
      ...
      <p>
        ...
        that feat for the city of El Paso that year). It was during this time
        that I discovered my passion for coding through the robotics club, which
        sparked my interest in the world of programming and ignited my curiosity
        to explore the endless possibilities of software development.
      </p>
      <p>
        {" "}
        ...
        forced me to reevaluate my priorities. As a result, I had to withdraw
      ...
      <p>
        ...
        contribute to the dynamic world of software development. With a firm
        belief in the power of technology to drive positive change, I am excited
        to be part of innovative projects that shape the future and make a
