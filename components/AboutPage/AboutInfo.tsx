...
const AboutInfo = () => {
    return (
        <>
            ...
            <p className={ css.aboutMe }> Born and raise in the border city of <span className='purple'>El Paso, Texas.</span> Ever since I was young, I strived to make the most of myself. I participated in community sports, educational clubs (mostly school math club), and Boy Scouts. These kept me active and spending a lot of time either outdoors or solving equations, which is where my fascination with nature ( GREEN-ery =&gt; GREEN-ough 🤣) and my love of math began. Both are big parts of my identity to this day.</p>
