...
const ContactModal = () => {
  ...
  return (
    <div id="contactMe" className={css.emailConnect}>
      <div className={css.close} onClick={() => toggleContactModal(css.open)}></div>
      <form
      ...
      >
        <button
          className={css.close}
          onClick={() => toggleContactModal(css.open)}
        >
          X
        </button>
        <h1>Contact Me</h1>
        <p>
          Please No solicitations, advertising, product endorsements, selling,
